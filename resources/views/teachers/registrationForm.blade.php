...
<x-menu />
<body>
    <form id="registration_form" class="form" action="{{BASEURL}}/teachers/register/t" method="POST">   <!-- form for creating account -->
        @csrf
        {{--<div id="form_email">--}}
        ...
        <div class="form_password">--}}
            <input type="password" id="password" name="password" placeholder="Password"{{--Come up with some password"--}}>
